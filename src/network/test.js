...
var  buildQuery = function(t) {
    var Q = ["mw-pv", "mw-sign", "mw-did"];
    var e = t.headers
    ...
    return n.push(t.api),
        ...
        n.push("bf0a1bc70ad1503751c72c7b273efa41_1640067672617"),
        n.join("&")
}

var t = {
    "statistics": {
        "_start": 1640316023009,
        "_timer": {
            "INIT": {
                "start": 1640316023009,
                "end": 1640316023044
    ...
    "headers": {
        ...
        "mw-t": "1640316023044",
        "mw-uuid": "87a63ac6-471b-458f-9ede-6f8346a00f02",
        "mw-h5-os": "Android"
    },
    "options": {
        "useHTTPS": true,
   ...
   // "__data": "{\"template\":\"6-2-detail_normal-1.0.0\",\"iid\":\"1n16k3i\",\"debug\":false,\"smbi\":true,\"sourceParams\":\"null\"}"
};

t.getDataString = function () {
    return this.__data ? this.__data : this.__data = (t = this.data) ? "string" == typeof t ? t : JSON.stringify(t) : "";
    var t
}


console.log(z(buildQuery(t)));